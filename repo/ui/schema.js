...
async function saveSchema(schemaPath, outputPath) {
    try {
        ...
        await fs.promises.writeFile(outputPath, JSON.stringify({ headers: tableHeaders, binaryStr, properties: tableHeadersProperties, grid: schema.grid }, null, 2));
